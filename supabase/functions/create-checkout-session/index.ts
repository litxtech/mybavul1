// FIX: Corrected the Supabase functions type reference to a valid URL to resolve Deno namespace type errors.
/// <reference types="https://unpkg.com/@supabase/functions-js@2.4.1/dist/edge-functions.d.ts" />
