...
const enTranslations = {
  ...
  'search.destination': 'Destination', 'search.checkin': 'Check-in', 'search.checkout': 'Check-out', 'search.guests': 'Guests', 'search.button': 'Search', 'search.button.loading': 'Searching...', 'search.placeholder': 'e.g. Istanbul', 'search.withImage': 'Search with an image',
  'city.barcelona': 'Barcelona', 'city.madrid': 'Madrid', 'city.palma': 'Palma', 'city.istanbul': 'Istanbul',
  'results.title': 'Results for "{city}"', 'results.noResults': 'No properties found for your search.', 'results.backToHome': 'New Search', 'results.allDestinations': 'All Destinations', 'results.visualSearchTitle': 'Visually Similar Stays',
  ...
  'destination.antalya': 'Antalya',
  'destination.cappadocia': 'Cappadocia',
...
const translations: Record<string, Record<string, string>> = {
  ...
  tr: {
    ...
    'search.destination': 'Destinasyon', 'search.checkin': 'Giriş', 'search.checkout': 'Çıkış', 'search.guests': 'Misafirler', 'search.button': 'Ara', 'search.placeholder': 'örn. İstanbul', 'search.withImage': 'Görsel ile Ara',
    'city.barcelona': 'Barselona', 'city.madrid': 'Madrid', 'city.palma': 'Palma', 'city.istanbul': 'İstanbul',
    'results.title': '"{city}" için sonuçlar', 'results.noResults': 'Aramanız için tesis bulunamadı.', 'results.backToHome': 'Yeni Arama', 'results.visualSearchTitle': 'Görsel Olarak Benzer Konaklamalar',
    ...
    'destination.antalya': 'Antalya',
    'destination.cappadocia': 'Kapadokya',
